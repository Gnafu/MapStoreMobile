...
public class NavUtils {
    ...
    /**
     * return a list of menu entries for the navdrawer may contain downloaded templates
     * 
     * @param app context
     * @return
     */
    public static NavDrawerItem[] getNavMenu(Activity app) {
        ...
        final ArrayList<MissionTemplate> persistedTemplates = PersistenceUtils
                .loadSavedTemplates(app);
        ...
        items[1] = NavMenuItem.create(101, app.getString(R.string.reporting),
                "ic_collections_view_as_list", false, app);
        items[2] = NavMenuItem
                .create(1001,
                        app.getString(R.string.my_inspections_my) + " "
                                + app.getString(R.string.reporting), "ic_collections_view_as_list",
                        false, app);
        ...
        if (persistedTemplates != null) {
            ...
            for (int i = 0, k = 0; i < persistedTemplates.size(); i++, k += 2) {
                ...
                items[3 + k + 1] = NavMenuItem.create(DOWNLOADED_TEMPLATE_ID + k + 1, app.getString(R.string.my_inspections_my) + " " + t.title,
                        "ic_collections_view_as_list", false, app);
            }
        }
